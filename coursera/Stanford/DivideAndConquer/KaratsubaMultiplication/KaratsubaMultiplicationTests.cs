...
namespace KaratsubaMultiplication
{
    public class KaratsubaMultiplicationTests
    {
        ...
        public void MultiplyTests(string first, string second, string expectedResult) => Assert.Equal(expectedResult, Multiply(first, second));
        ...
        public void AddTests(string first, string second, string expectedResult) => Assert.Equal(expectedResult, Add(first, second));
        ...
        [InlineData("18", "8", "10")]
        public void SubstractTest(string first, string second, string expectedResult) => Assert.Equal(expectedResult,  Substract(first, second));
